...
//clock
float timer_max = 10;
float timer_current = timer_max;

//death and start screen
bool close_game;
...
Texture2D river_desert1;
Texture2D river_desert2;
...
void DrawUI() {
	...
	DrawRectangle(tile_size * 4, tile_size * 0.45, leangth, tile_size * 0.4, (leangth <= tile_size * 2) ? RED : GREEN);
}
void DrawEnemies() {
